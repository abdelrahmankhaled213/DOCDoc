...
class ResponseMessage {
  ...
  static const String BAD_REQUEST =
      ApiErrors.badRequest; // failure, API rejected request
  static const String UNAUTORISED =
      ApiErrors.unauthorised; // failure, user is not authorised
  static const String FORBIDDEN =
      ApiErrors.forbidden; //  failure, API rejected request
  static const String INTERNAL_SERVER_ERROR =
      ApiErrors.internalServerError; // failure, crash in server side
  static const String NOT_FOUND =
      ApiErrors.notFound; // failure, crash in server side

  // local status code
  static String CONNECT_TIMEOUT = ApiErrors.connectTimeout;
  static String RECIEVE_TIMEOUT = ApiErrors.receiveTimeout;
  static String SEND_TIMEOUT = ApiErrors.sendTimeout;
  static String CACHE_ERROR = ApiErrors.cacheError;
  static String NO_INTERNET_CONNECTION = ApiErrors.noInternetConnection;
  static String cancelError=ApiErrors.cancelError;
  ...
  ApiErrorModel getFailure() {
    switch (this) {
      ...
      case DataSource.CANCEL:
        return ApiErrorModel(
            code: ResponseCode.CANCEL, message: ResponseMessage.cancelError);
